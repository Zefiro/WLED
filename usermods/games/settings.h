...
#define RESET_BUTTON_DURATION_MS 7000
#define RECALIBRATE_BUTTON_DURATION_MS 500
#define AUTO_RECALIBRATE_DURATION_MS 20000

#define DEFAULT_JOYSTICK_DEADZONE    8     // Angle to ignore
#define MIN_JOYSTICK_DEADZONE 3
#define MAX_JOYSTICK_DEADZONE 12

#define ANALOG_JOYSTICK_X_PIN 34 // ADC1, Channel 6 -- P34
#define ANALOG_JOYSTICK_Y_PIN 35 // ADC1, Channel 7 -- P35
...
long lastInputTime_Decalibrated = 0;
...
void change_setting(char paramCode, uint16_t newValue)
{
    ...
    case 'O': // LED Offset
        user_settings.led_offset = constrain(newValue, 0, MAX_LEDS);
        settings_eeprom_write();
    break;  
